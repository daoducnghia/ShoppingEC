<div class="price-filter top-4">
    <div class="filter-item-title">PRICE</div>
    <ul class="unlist-filter">
        <li>
            <a href="">
                ...
                <span class="filter-option">Under $100</span>
            </a>
        </li>
        <li>
            <a href="">
                ...
                <span class="filter-option">$100 - $500</span>
            </a>
        </li>
        <li>
            <a href="">
                ...
                <span class="filter-option">Over $500</span>
            </a>
        </li>
    </ul>
</div>
